            ...
            try
            {
                ...
                return Json(new
                {
                    ...
                    resSuggestions = resSuggestions
                        .Select(s => new { s.Id, s.UniqueCode, s.Name, s.Description, country = s.Address.Country.Title, city = s.Address.City.Title, region = s.Address.Region.Title, address = s.Address.AddressText, starsRating = new short[s.StarsRating], s.BookingCategory.Category,
