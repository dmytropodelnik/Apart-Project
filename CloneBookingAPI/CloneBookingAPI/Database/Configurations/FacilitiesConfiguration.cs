        ...
        public void Configure(EntityTypeBuilder<Facility> builder)
        {
            builder.HasData(
              new Facility[]
              {
                ...
                new Facility { Id = 36, Text = "Free public parking is available on site (reservation is not needed).", FacilityTypeId = 12, ImageId = 1 },
                ...
                new Facility { Id = 40, Text = "Restaurant", FacilityTypeId = 13, ImageId = 1 },
