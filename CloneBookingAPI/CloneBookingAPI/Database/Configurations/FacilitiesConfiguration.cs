        ...
        public void Configure(EntityTypeBuilder<Facility> builder)
        {
            builder.HasData(
              new Facility[]
              {
                ...
                new Facility { Id = 33, Text = "Street parking", FacilityTypeId = 12, ImageId = 1 },
                new Facility { Id = 34, Text = "Restaurant", FacilityTypeId = 13, ImageId = 1 },
                new Facility { Id = 35, Text = "Baggage storage", FacilityTypeId = 14, ImageId = 1 },
                new Facility { Id = 36, Text = "Tour desk", FacilityTypeId = 14, ImageId = 1 },
                new Facility { Id = 37, Text = "Currency exchange", FacilityTypeId = 14, ImageId = 1 },
                new Facility { Id = 38, Text = "24-hour front desk", FacilityTypeId = 14, ImageId = 1 },
                new Facility { Id = 39, Text = "Designated smoking area", FacilityTypeId = 15, ImageId = 1 },
                new Facility { Id = 40, Text = "Air conditioning", FacilityTypeId = 15, ImageId = 1 },
                new Facility { Id = 41, Text = "Heating", FacilityTypeId = 15, ImageId = 1 },
                new Facility { Id = 42, Text = "Chapel/Shrine", FacilityTypeId = 15, ImageId = 1 },
                new Facility { Id = 43, Text = "Elevator", FacilityTypeId = 15, ImageId = 1 },
                new Facility { Id = 44, Text = "Family rooms", FacilityTypeId = 15, ImageId = 1 },
