        ...
        public void Configure(EntityTypeBuilder<Facility> builder)
        {
            builder.HasData(
              new Facility[]
              {
                ...
                new Facility { Id = 33, Text = "Restaurant", FacilityTypeId = 10, ImageId = 1 },
                new Facility { Id = 34, Text = "English", FacilityTypeId = 11, ImageId = 1 },
                new Facility { Id = 35, Text = "Hebrew", FacilityTypeId = 11, ImageId = 1 },
                new Facility { Id = 36, Text = "Free public parking available", FacilityTypeId = 12, ImageId = 1 },
                new Facility { Id = 37, Text = "Street parking", FacilityTypeId = 12, ImageId = 1 },
                new Facility { Id = 38, Text = "Free Wifi", FacilityTypeId = 13, ImageId = 1 },
                new Facility { Id = 39, Text = "Restaurant", FacilityTypeId = 13, ImageId = 1 },
                new Facility { Id = 40, Text = "Restaurant1", FacilityTypeId = 13, ImageId = 1 },
