...
export class PaymentTypesListComponent implements OnInit {
  ...
  addType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/paymenttypes/addtype', {
      method: 'POST',
      headers: {
  ...
  editType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/paymenttypes/edittype', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/paymenttypes/deletetype', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getTypes(): void {
    fetch(`http://apartmain.azurewebsites.net/api/paymenttypes/getpaymenttypes?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
