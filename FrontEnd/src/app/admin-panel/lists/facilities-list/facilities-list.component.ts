...
export class FacilitiesListComponent implements OnInit {
  ...
  search(): void {
    fetch('http://apartmain.azurewebsites.net/api/facilities/search?facility=' + this.searchFacility, {
      method: 'GET',
      headers: {
  ...
  addFacility(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/facilities/addfacility', {
      method: 'POST',
      headers: {
  ...
  editFacility(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/facilities/editfacility', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteFacility(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/facilities/deletefacility', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getFacilities(): void {
    fetch(`http://apartmain.azurewebsites.net/api/facilities/getfacilities?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
  ...
  getFacilityTypes(): void {
    fetch('http://apartmain.azurewebsites.net/api/facilitytypes/gettypes', {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
