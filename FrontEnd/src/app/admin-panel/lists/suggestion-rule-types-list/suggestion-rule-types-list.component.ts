...
export class SuggestionRuleTypesListComponent implements OnInit {
  ...
  search(): void {
    fetch('http://apartmain.azurewebsites.net/api/suggestionruletypes/search?type=' + this.searchType, {
      method: 'GET',
      headers: {
  ...
  addType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/suggestionruletypes/addtype', {
      method: 'POST',
      headers: {
  ...
  editType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/suggestionruletypes/edittype', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/suggestionruletypes/deletetype', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getTypes(): void {
    fetch(`http://apartmain.azurewebsites.net/api/suggestionruletypes/gettypes?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
