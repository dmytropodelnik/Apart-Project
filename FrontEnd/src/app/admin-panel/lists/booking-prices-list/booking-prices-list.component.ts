...
export class BookingPricesListComponent implements OnInit {
  ...
  addPrice(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/bookingprices/addprice', {
      method: 'POST',
      headers: {
  ...
  editPrice(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/bookingprices/editprices', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deletePrice(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/bookingprices/deleteprice', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getPrices(): void {
    fetch(`http://apartmain.azurewebsites.net/api/bookingprices/getprices?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
