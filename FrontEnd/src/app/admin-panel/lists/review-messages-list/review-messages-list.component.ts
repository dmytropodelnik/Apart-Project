...
export class ReviewMessagesListComponent implements OnInit {
  ...
  addMessage(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/reviewmessages/addmessage', {
      method: 'POST',
      headers: {
  ...
  editMessage(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/reviewmessages/editmessage', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteMessage(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/reviewmessages/deletemessage', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getMessages(): void {
    fetch(`http://apartmain.azurewebsites.net/api/reviewmessages/getmessages?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
