...
export class SurroundingObjectTypesListComponent implements OnInit {
  ...
  search(): void {
    fetch('http://apartmain.azurewebsites.net/api/surroundingobjecttypes/search?type=' + this.searchType, {
      method: 'GET',
      headers: {
  ...
  addType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/surroundingobjecttypes/addtype', {
      method: 'POST',
      headers: {
  ...
  editType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/surroundingobjecttypes/edittype', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteType(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/surroundingobjecttypes/deletetype', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getTypes(): void {
    fetch(`http://apartmain.azurewebsites.net/api/surroundingobjecttypes/gettypes?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
