...
export class SuggestionsListComponent implements OnInit {
  ...
  addSuggestion(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/suggestions/addsuggestion', {
      method: 'POST',
      headers: {
  ...
  editSuggestion(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/suggestions/editsuggestion', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteSuggestion(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/suggestions/deletesuggestion', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getSuggestions(): void {
    fetch(`http://apartmain.azurewebsites.net/api/suggestions/getsuggestions?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
