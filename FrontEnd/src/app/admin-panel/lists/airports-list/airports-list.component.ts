...
export class AirportsListComponent implements OnInit {
  ...
  addAirport(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/airports/addairport', {
      method: 'POST',
      headers: {
  ...
  editAirport(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/airports/editairport', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteAirport(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/airports/deleteairport', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getAirports(): void {
    fetch(`http://apartmain.azurewebsites.net/api/airports/getairports?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
