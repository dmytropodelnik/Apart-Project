...
export class StayBookingsListComponent implements OnInit {
  ...
  addRole(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/staybookings/addbooking', {
      method: 'POST',
      headers: {
  ...
  editBooking(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/staybookings/editbooking', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteBooking(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/staybookings/deletebooking', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getBookings(): void {
    fetch('http://apartmain.azurewebsites.net/api/staybookings/getbookings', {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
