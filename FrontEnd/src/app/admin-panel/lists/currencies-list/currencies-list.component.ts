...
export class CurrenciesListComponent implements OnInit {
  ...
  search(): void {
    fetch('http://apartmain.azurewebsites.net/api/currencies/search?currency=' + this.searchCurrency, {
      method: 'GET',
      headers: {
  ...
  addCurrency(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/currencies/addcurrency', {
      method: 'POST',
      headers: {
  ...
  editCurrency(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/currencies/editcurrency', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteCurrency(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/currencies/deletecurrency', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getCurrencies(): void {
    fetch(`http://apartmain.azurewebsites.net/api/currencies/getcurrencies?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
