...
export class FavoritesListComponent implements OnInit {
  ...
  search(): void {
    fetch('https://apartmain.azurewebsites.net/api/favorites/search?favorite=' + this.searchFavorite, {
      method: 'GET',
      headers: {
  ...
  getFavorites(): void {
    fetch(`https://apartmain.azurewebsites.net/api/favorites/getfavorites?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
