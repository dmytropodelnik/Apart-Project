...
export class ReviewCategoriesListComponent implements OnInit {
  ...
  search(): void {
    fetch('http://apartmain.azurewebsites.net/api/reviewcategories/search?category=' + this.searchCategory, {
      method: 'GET',
      headers: {
  ...
  addCategory(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/categories/addcategory', {
      method: 'POST',
      headers: {
  ...
  editCategory(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/categories/editcategory', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  deleteCategory(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/categories/deletecategory', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getCategories(): void {
    fetch(`http://apartmain.azurewebsites.net/api/reviewcategories/getcategories?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
