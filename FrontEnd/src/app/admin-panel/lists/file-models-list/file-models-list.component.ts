...
export class FileModelsListComponent implements OnInit {
  ...
  search(): void {
    fetch('http://apartmain.azurewebsites.net/api/files/search?file=' + this.searchFile, {
      method: 'GET',
      headers: {
  ...
  addFile(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/files/addimage', {
      method: 'POST',
      headers: {
  ...
  deleteFile(): void {
    ...
    fetch('http://apartmain.azurewebsites.net/api/files/deleteimage', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
        Accept: 'application/json',
  ...
  getFiles(): void {
    fetch(`http://apartmain.azurewebsites.net/api/files/getimages?page=${this.page}&pageSize=${this.pageSize}`, {
      method: 'GET',
    })
      .then((r) => r.json())
      .then((data) => {
